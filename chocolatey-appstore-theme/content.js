(function($) {
	...
	$(function() {
		...
		$(`
			<div id="callout-install-help" class="callout callout-warning py-2">
				<div class="d-md-flex justify-content-md-between align-items-md-center">
					...
					<div class="mt-2 mt-md-0">
						<a class="collapse show btn btn-sm btn-secondary" data-toggle="collapse" href="#package-warning" role="button" title="Installation help">
							Hide Notification
						</a>
					</div>
				</div>
				<div class="mt-2 collapse show" id="package-warning" style="">
		...
		`).insertAfter('#callout-package-warning');


		$('.input-group:has(input[value*="choco install"])').each((i, e) => {
			
			let val = $('input[value*="choco install"]', e).val().replace('choco install', '').trim();
